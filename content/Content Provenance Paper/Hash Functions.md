...
Note that this is somewhat similar to [[5-One Way Functions#Collection of One-Way Functions]]. 
Section 5.5 from cornell notes deals with this
These are potentially stronger (source: cornell notes)
...
Incase u forgot: [[4-Efficient Computing#Probabilistic Poly-time Turing Machines (PPTs)]]
## Intuition
